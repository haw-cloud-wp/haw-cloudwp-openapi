...
type DefaultApiRouter interface { 
	...
	GetV1BucketBucketNameTranslateFileName(http.ResponseWriter, *http.Request)
	...
	OptionsV1BucketBucketNameTranslateFileName(http.ResponseWriter, *http.Request)
...
type DefaultApiServicer interface { 
	...
	GetV1BucketBucketNameTranslateFileName(context.Context, string, string) (ImplResponse, error)
	...
	OptionsV1BucketBucketNameTranslateFileName(context.Context, string, string, OptionsV1BucketBucketNameTranslateFileNameRequest) (ImplResponse, error)
